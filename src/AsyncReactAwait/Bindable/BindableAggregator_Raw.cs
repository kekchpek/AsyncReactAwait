...
namespace AsyncReactAwait.Bindable
{
    ...
    public class BindableAggregator<TRes> : IBindable<TRes>, IBindableRaw
    {
        ...
        private readonly Func<IBindableRaw[], TRes> _aggregator;
        ...
        /// <summary>
        /// Fired every time any listener is bound to this aggregator.
        /// </summary>
        public event Action? OnAnySubscription;

        /// <summary>
        /// Fired when a listener is unbound and there are no more listeners left.
        /// </summary>
        ...
        public BindableAggregator(IEnumerable<IBindableRaw> bindableRaws, Func<IReadOnlyList<IBindableRaw>, TRes> aggregator)
        {
