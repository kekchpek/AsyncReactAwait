...
{
    /// <summary>
    /// Aggregates three bindable values into a new bindable value.
    /// </summary>
    public sealed class BindableAggregator<T1, T2, T3, TRes> : IBindable<TRes>, IBindableRaw
    {
        private readonly IBindable<T1> _b1;
        private readonly IBindable<T2> _b2;
        private readonly IBindable<T3> _b3;
        private readonly Func<T1, T2, T3, TRes> _aggregator;
        ...
        private TRes Compute() => _aggregator(_b1.Value, _b2.Value, _b3.Value);
